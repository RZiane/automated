...
def evaluate(gold_ud, system_ud):
    ...
    return {
        ...
        "DEPREL": alignment_score(alignment, lambda w, _: w.columns[DEPREL]),
...
def main():
    ...
    if not args.verbose and not args.counts:
        print("LAS F1 Score: {:.2f}".format(100 * evaluation["LAS"].f1)+"\n"+"UAS F1 Score: {:.2f}".format(100 * evaluation["UAS"].f1)+"\n"+"DEPREL F1 Score: {:.2f}".format(100 * evaluation["DEPREL"].f1)+"\n"+"UPOS F1 Score: {:.2f}".format(100 * evaluation["UPOS"].f1))
